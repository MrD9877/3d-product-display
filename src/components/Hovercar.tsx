...
Command: npx gltfjsx@6.5.3 -t public/models/hoverCar2.glb 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    ["Plane.005_0"]: THREE.MeshStandardMaterial;
  };
...
export function Hovercar(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Sketchfab_Scene" position={[0, -0.237, -0.292]} scale={0.325}>
